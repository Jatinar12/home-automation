Feature: Property Detail Page
    ...
    Background:
        ...
        # When I click on the close button on the pop up modal
    ...
    #     Then I should see breadcrumb present on pdp page
    ...
    #     And I should see the configuration in the pdp page heading
    ...
    #     And I should see "Livability Rating" text on the image
    #     When I hover over "Livability Rating" text on the image
    #     And I should see "Investment Rating" text on the image
    ...
    #     And I click on "Price Breakup" column on the pricing and floor section
    ...
    #     And I check the accept the term checkbox on popup form
    #     And I check the homeloans checkbox on popup form
    #     And I click on "Get Best Quote" button on popup form
    #     Then I should see the OTP modal on the page
